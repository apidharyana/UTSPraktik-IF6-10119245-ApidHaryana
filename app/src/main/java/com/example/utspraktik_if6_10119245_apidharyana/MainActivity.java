...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!Objects.equals(status, "")){
            ...
            if (Objects.equals(tes, "Rapid Tes")){
                radioSexGroup.check(R.id.rapid);
            }else if(Objects.equals(tes, "PCR")){
                radioSexGroup.check(R.id.pcr);
            }

            if (Objects.equals(jk, "Perempuan")){
                radioSexGroup.check(R.id.jk_p);
            }else if(Objects.equals(jk, "Laki - laki")){
                radioSexGroup.check(R.id.jk_l);
            }

            if (Objects.equals(hub, "Orang Tua")){
                radioHub.check(R.id.hub_ortu);
            }else if (Objects.equals(hub, "Suami / Istri")){
                radioHub.check(R.id.hub_suis);
            }else if (Objects.equals(hub, "Anak")){
                radioHub.check(R.id.hub_anak);
            }else if(Objects.equals(hub, "Kerabat Lainnya")){
